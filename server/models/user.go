...
var (
	userColumns               = []string{"id", "type", "email", "hashed_password", "name", "created_at", "updated_at"}
	userColumnsWithoutDefault = []string{"id", "type", "email", "hashed_password", "name", "created_at", "updated_at"}
...
func Users(mods ...qm.QueryMod) userQuery {
	mods = append(mods, qm.From("\"taeho\".\"user\""))
...
func FindUser(ctx context.Context, exec boil.ContextExecutor, iD int64, selectCols ...string) (*User, error) {
	...
	query := fmt.Sprintf(
		"select %s from \"taeho\".\"user\" where \"id\"=$1", sel,
	)
...
func (o *User) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	...
	if !cached {
		...
		if len(wl) != 0 {
			cache.query = fmt.Sprintf("INSERT INTO \"taeho\".\"user\" (\"%s\") %%sVALUES (%s)%%s", strings.Join(wl, "\",\""), strmangle.Placeholders(dialect.UseIndexPlaceholders, len(wl), 1, 1))
		} else {
			cache.query = "INSERT INTO \"taeho\".\"user\" %sDEFAULT VALUES%s"
		}
...
func (o *User) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		cache.query = fmt.Sprintf("UPDATE \"taeho\".\"user\" SET %s WHERE %s",
...
func (o UserSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	sql := fmt.Sprintf("UPDATE \"taeho\".\"user\" SET %s WHERE %s",
...
func (o *User) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	...
	if !cached {
		...
		cache.query = buildUpsertQueryPostgres(dialect, "\"taeho\".\"user\"", updateOnConflict, ret, update, conflict, insert)
...
func (o *User) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	sql := "DELETE FROM \"taeho\".\"user\" WHERE \"id\"=$1"
...
func (o UserSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	sql := "DELETE FROM \"taeho\".\"user\" WHERE " +
...
func (o *UserSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	sql := "SELECT \"taeho\".\"user\".* FROM \"taeho\".\"user\" WHERE " +
		strmangle.WhereClauseRepeated(string(dialect.LQ), string(dialect.RQ), 1, userPrimaryKeyColumns, len(*o))
...
func UserExists(ctx context.Context, exec boil.ContextExecutor, iD int64) (bool, error) {
	var exists bool
	sql := "select exists(select 1 from \"taeho\".\"user\" where \"id\"=$1 limit 1)"
